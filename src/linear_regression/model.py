...
class LinearRegression:  
    ...
    def __init__(self, learning_rate=0.01, batch_size=32, cost_function='mse', gradient_method='batch', num_iterations=1000, early_stopping_steps=10):
        self.__set_params(learning_rate, batch_size, cost_function, gradient_method, num_iterations, early_stopping_steps)
    ...
    def fit(self, X, Y, params={}):
        ...
        for i in range(self._num_iterations):
            ...
            # no_improvement_count = no_improvement_count + 1 if loss >= min_loss - 1 else 0 # 1 as non-significant improvement
